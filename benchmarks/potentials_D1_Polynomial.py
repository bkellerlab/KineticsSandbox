...
if test_V:
    ...
    for c1 in np.linspace(-3, 3, 7):
        ...
        plt.plot(
            x, this_potential.potential(x), color=color, label="c1={:.2f}".format(c1)
        )
    ...
    for c2 in np.linspace(-2, 10, 7):
        ...
        plt.plot(
            x, this_potential.potential(x), color=color, label="c2={:.2f}".format(c2)
        )
    ...
    for c3 in np.linspace(-2, 2, 5):
        ...
        plt.plot(
            x, this_potential.potential(x), color=color, label="c3={:.2f}".format(c3)
        )
    ...
    for c4 in np.linspace(-8, 2, 6):
        ...
        plt.plot(
            x, this_potential.potential(x), color=color, label="c4={:.2f}".format(c4)
        )
    ...
    for c5 in np.linspace(-2, 2, 5):
        ...
        plt.plot(
            x, this_potential.potential(x), color=color, label="c5={:.2f}".format(c5)
        )
    ...
    for c6 in np.linspace(-0.5, 2, 6):
        ...
        plt.plot(
            x, this_potential.potential(x), color=color, label="c6={:.2f}".format(c6)
        )
